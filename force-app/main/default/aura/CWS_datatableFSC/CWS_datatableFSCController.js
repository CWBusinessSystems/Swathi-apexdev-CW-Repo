({
    init: function (cmp, event, helper) {
        ...
        if(cmp.get('v.mydata_custom4') && cmp.get('v.mydata_custom4').length > 0){
            cmp.set('v.mydata', cmp.get('v.mydata_custom4'));
            cmp.set('v.obj', 'custom4');
            cmp.set('v.preSelection', cmp.get('v.selectedRows_custom4'));
        }
    ...
    getSelectedName: function (cmp, event) {
        ...
        if(obj == 'standard1'){
            ...
            cmp.set("v.selectedRows_custom3", selectedRows);   
        }
        else if(obj == 'custom4'){
            cmp.set("v.selectedRows_custom4", selectedRows);
        }
